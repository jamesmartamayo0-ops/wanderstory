...
export default function JourneyCard({ journey }: JourneyCardProps) {
  ...
  return (
    <article className="group flex flex-col overflow-hidden rounded-[var(--radius-card)] bg-[var(--color-surface)] shadow-[var(--shadow-elevated)] transition-shadow duration-300 hover:shadow-lg">
      ...
      <div className="flex flex-1 flex-col gap-3 p-5">
        <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
          <span className="flex items-center gap-1 font-[family-name:var(--font-button)] text-xs font-semibold uppercase tracking-[0.12em] text-[var(--color-ocean-600)]">
        ...
        <p className="font-[family-name:var(--font-body)] text-sm leading-relaxed text-neutral-500 line-clamp-3">
          {introduction}
        </p>
        ...
        <div className="mt-auto flex items-center justify-between pt-2">
          ...
          {chapterCount > 0 && (
            <span className="flex items-center gap-1 font-[family-name:var(--font-button)] text-xs font-medium text-neutral-400">
